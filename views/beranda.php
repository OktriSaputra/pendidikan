    ...
    <div class="container about">
      <div class="row py-5">
        <div class="col-md-12 my-3">
          <div class="jumbotron">
            <h1 class="display-4">Learning<i>Space</i></h1>
            <p class="lead">Learning<i>Space</i> merupakan aplikasi berbasis web yang menyediakan ruang belajar untuk dapat diakses oleh kalangan umum khususnya bagi siswa siswi sekolah dasar. Sehingga mereka dapat memanfaatkan kemajuan teknologi dengan lebih baik.</p>
            <hr class="my-4">
            <div class="row">
              <div class="col-md-4">
                <img src="<?php echo base_url(); ?>/assets/images/6.jpg" width="100%">
              </div>
              <div class="col-md-8">
                <h4>Learning<i>Space</i></h4>
                <p>Selamat Datang di Learning<i>Space</i>, Learning<i>Space</i> adalah media belajar yang dapat membantu adik-adik dalam mengakses materi sekolah dasar dari kelas 1 sampai kelas 6. Pada Learning<i>Space</i> ini adik-adik tentunya dapat belajar tanpa harus cari-cari buku, karena di Learning<i>Space</i> semua ada disini.</p>
              </div>
            </div>
          </div>
        </div>
